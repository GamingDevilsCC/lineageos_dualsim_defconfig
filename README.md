...
CONFIG_LOCALVERSION="-Moun_Kernel_V4.0"
...
# CONFIG_LESS_OPTIMIZATION is not set
CONFIG_MORE_OPTIMIZATION=y
CONFIG_SYSCTL=y
...
# CONFIG_IOSCHED_SIOPLUS is not set
# CONFIG_IOSCHED_ZEN is not set
# CONFIG_IOSCHED_VR is not set
# CONFIG_IOSCHED_TRIPNDROID is not set
...
# CONFIG_ARCH_MSMKRYPTON is not set
...
# LGE Board Selection
#
CONFIG_MACH_MSM8974_G3=y
# CONFIG_MACH_MSM8974_G3_KR is not set
# CONFIG_MACH_MSM8974_G3_VZW is not set
# CONFIG_MACH_MSM8974_G3_ATT is not set
# CONFIG_MACH_MSM8974_G3_SPR_US is not set
# CONFIG_MACH_MSM8974_G3_TMO_US is not set
# CONFIG_MACH_MSM8974_G3_GLOBAL_COM is not set
# CONFIG_MACH_MSM8974_G3_CA is not set
CONFIG_MACH_MSM8974_G3_CN=y
CONFIG_DTS_TARGET="msm8974pro-g3-cn"
CONFIG_LGE_BOOTLOADER_LOG=y
CONFIG_LGE_PSEUDO_CHG_UI=y
CONFIG_LGE_BOOTLOADER_TIME_CHECKER=y
CONFIG_LGE_USES_SMD_DS_TTY=y
CONFIG_LGE_KSWITCH=y
CONFIG_LGE_QFPROM_INTERFACE=y
# CONFIG_SHITTY_VARIANT is not set
...
# CONFIG_MSM_SPM_REGULATOR is not set
# CONFIG_MSM_SMCMOD is not set
CONFIG_MSM_SUBSYSTEM_RESTART=y
CONFIG_MSM_SYSMON_COMM=y
CONFIG_MSM_PIL=y
# CONFIG_MSM_PIL_MODEM is not set
# CONFIG_MSM_PIL_QDSP6V3 is not set
# CONFIG_MSM_PIL_LPASS_QDSP6V4 is not set
# CONFIG_MSM_PIL_MODEM_QDSP6V4 is not set
CONFIG_MSM_PIL_LPASS_QDSP6V5=y
CONFIG_MSM_PIL_MSS_QDSP6V5=y
# CONFIG_MSM_PIL_RIVA is not set
...
CONFIG_MSM_AUDIO_QDSP6V2=y
CONFIG_MSM_ADSP_LOADER=y
# CONFIG_MSM_ULTRASOUND_A is not set
CONFIG_MSM_ULTRASOUND_B=y
...
# CONFIG_MSM_CPR_REGULATOR is not set
...
# CONFIG_DONT_MAP_HOLE_AFTER_MEMBANK0 is not set
...
#
CONFIG_LGE_NFC=y
# CONFIG_LGE_NFC_PN544_C2 is not set
# CONFIG_LGE_NFC_PN544_C3 is not set
CONFIG_LGE_NFC_PN547_C2=y
# CONFIG_LGE_NFC_PRESTANDBY is not set
# CONFIG_LGE_NFC_MULTICORE_FASTBOOT is not set
CONFIG_LGE_NFC_SET_IRQ_WAKEUP=y
# CONFIG_LGE_NFC_DEBUG_MESSAGE is not set
CONFIG_LGE_NFC_USE_PMIC=y
...
CONFIG_BCMDHD_GPIO_WL_RESET=82
CONFIG_BCMDHD_HOSTWAKEUP_USE_GPIO=y
CONFIG_BCMDHD_GPIO_WL_HOSTWAKEUP=81
CONFIG_BCMDHD_HW_OOB=y
# CONFIG_BRCM_CCX is not set
# CONFIG_BCMDHD_USE_SCHED_SCAN is not set
CONFIG_BROADCOM_WIFI_RESERVED_MEM=y
# CONFIG_BRCM_WAPI is not set
# CONFIG_BCMDHD_HOSTAPD_BGN_MODE is not set
...
CONFIG_TOUCHSCREEN_SYNAPTICS_G3=y
CONFIG_TOUCHSCREEN_SYNAPTICS_FW_PATH="g3"
...
CONFIG_LGE_PM=y
CONFIG_LGE_PM_BATTERY_ID_CHECKER=y
CONFIG_LGE_PM_LLK_MODE=y
CONFIG_LGE_CHARGER_TEMP_SCENARIO=y
CONFIG_MAX17048_FUELGAUGE=y
CONFIG_LGE_CURRENTNOW=y
CONFIG_BQ24296_CHARGER=y
CONFIG_CHARGER_MAX77819=y
CONFIG_CHARGER_MAX8971=y
CONFIG_CHARGER_MAX8971_FORCE_SINGLE_CHARGING=y
CONFIG_CHARGER_UNIFIED_WLC=y
# CONFIG_CHARGER_UNIFIED_WLC_BQ5102X is not set
CONFIG_CHARGER_UNIFIED_WLC_ALIGNMENT=y
CONFIG_CHARGER_UNIFIED_WLC_ALIGNMENT_IDT9025A=y
# CONFIG_CHARGER_UNIFIED_WLC_ALIGNMENT_BQ5102X is not set
CONFIG_LGE_LOW_BATT_LIMIT=y
CONFIG_LGE_PM_USB_CURRENT_MAX_MODE=y
CONFIG_LGE_THERMALE_CHG_CONTROL=y
CONFIG_HWMON=y
...
# CONFIG_FB_MSM_LVDS_FRC_FHD is not set
...
CONFIG_LGE_SUPPORT_LCD_MAKER_ID=y
CONFIG_LGE_SHARPENING=y
...
CONFIG_BACKLIGHT_LM3631=y
CONFIG_MACH_LGE_BACKLIGHT_SUPPORT=y
...
CONFIG_USB_DWC3_LGE_SINGLE_PSY=y
...
CONFIG_LEDS_PM8941_EMOTIONAL=y
...
# CONFIG_VIBRATOR_PM8974_HAPTIC is not set
...
# CONFIG_CORESIGHT_ETB is not set
